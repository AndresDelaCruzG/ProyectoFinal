...
<!-- Script inhabilitar flechas del navegador -->
    ...
    <script type="text/javascript">
        ...
        function limpiar(){
            var curretAcum = sessionStorage.clear();
        }

    </script>
<body class="bodyCliente" onload="nobackbutton();">
    ...
    <section class="LoginC">
        <div class="clie">
         ...
         <table class="ClienteT">
            ...
            <tr>
                <td>
                    <asp:Button ID="Button1"  class="bo1" runat="server" Text="Ingresar" OnClientClick="return limpiar();"/> 
             ...
             <tr>
                <td>
                    ¿Aún no tienes cuenta? <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Registro_Cliente.aspx" Text="Crear cuenta"></asp:HyperLink>
                    <br />
                    <br />
